...
export const welcomeDialog = () => {
    ...
    let d = new Dialog({
        ...
        <p>${game.i18n.localize("DFT.MAIN.WELCOME.READFIRST")} <a class="content-link" draggable="true" data-link data-uuid="Compendium.dft.dft-information.JournalEntry.${lang === 'uk' ? '0sa63t1EjDle9Hr2':'eRW62Vqw12GWlDeT'}" data-id="${lang === 'uk' ? '0sa63t1EjDle9Hr2':'eRW62Vqw12GWlDeT'}" data-type="JournalEntryPage" data-pack="dft.dft-information" data-tooltip="Text Page"><i class="fas fa-file-lines"></i>${game.i18n.localize("DFT.MAIN.WELCOME.INFORMATION")}</a></p>
